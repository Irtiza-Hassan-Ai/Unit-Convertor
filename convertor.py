...
.stApp {
    background: linear-gradient(135deg, #cfe2f3);
    padding: 30px;
    border-radius: 15px;
...
.result-box {
    ...
    font-weight: bold;
    text-align: center;
    backgrounf: rgba(255, 255, 255, 0.1);
    padding: 25px;
    border-radius: 20px;
    margin-top: 20px;
...
#footer
st.markdown("<div class='footer'>Developed by @Abhishek</div>", unsafe_allow_html=True)
